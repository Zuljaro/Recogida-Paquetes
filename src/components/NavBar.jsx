    ...
    <div className="container px-5">
        ...
        <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ms-auto me-4 my-3 my-lg-0">
                <li className="nav-item"><a className="nav-link me-lg-3" href="#features">Ingresar</a></li>
                <li className="nav-item"><a className="nav-link me-lg-3" href="#download">Registrar</a></li>
